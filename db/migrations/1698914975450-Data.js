module.exports = class Data1698914975450 {
    name = 'Data1698914975450'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "group" ("id" character varying NOT NULL, "name" text NOT NULL, "enabled" boolean NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_256aa0fda9b1de1a73ee0b7106b" PRIMARY KEY ("id"))`)
        await db.query(`CREATE TABLE "smart_contract" ("id" character varying NOT NULL, "address" text NOT NULL, "chain" integer NOT NULL, "caller" text NOT NULL, "enabled" boolean NOT NULL, "azero_id" text NOT NULL, "abi_url" text NOT NULL, "contract_url" text, "wasm_url" text, "audit_url" text, "project_name" text, "project_website" text, "github" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "group_id" character varying, CONSTRAINT "PK_27627aca2eebd2eb72f26f6399a" PRIMARY KEY ("id"))`)
